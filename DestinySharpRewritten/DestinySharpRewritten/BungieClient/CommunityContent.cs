...
public string GetCommunityContent(Forum.ForumTopicsCategoryFiltersEnum mediaFilter,int page,Forum.CommunityContentSortMode sort)
{
...
public string GetCommunityLiveStatuses(int modeHash,int page,Partnerships.PartnershipType partnershipType,Community.CommunityStatusSort sort,string streamLocale)
{
...
/// <param name="partnershipType">The type of partnership for which the status should be returned.</param>
/// <param name="sort">The sort mode.</param>
public string GetCommunityLiveStatusesForClanmates(int page,Partnerships.PartnershipType partnershipType,Community.CommunityStatusSort sort)
{
...
/// <param name="partnershipType">The type of partnership for which the status should be returned.</param>
/// <param name="sort">The sort mode.</param>
public string GetCommunityLiveStatusesForFriends(int page,Partnerships.PartnershipType partnershipType,Community.CommunityStatusSort sort)
{
...
/// <param name="sort">The sort mode.</param>
/// <param name="streamLocale">The locale for streams you'd like to see.  Don't pass this to fall back on your BNet locale.  Pass 'ALL' to not filter by locale.</param>
public string GetFeaturedCommunityLiveStatuses(int page,Partnerships.PartnershipType partnershipType,Community.CommunityStatusSort sort,string streamLocale)
{
...
public string GetStreamingStatusForMember(int membershipId,BungieMembershipType membershipType,Partnerships.PartnershipType partnershipType)
{

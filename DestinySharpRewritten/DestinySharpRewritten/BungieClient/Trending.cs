...
public string GetTrendingCategory(string categoryId,int pageNumber)
{
...
public string GetTrendingEntryDetail(string identifier,Trending.TrendingEntryType trendingEntryType)
{
